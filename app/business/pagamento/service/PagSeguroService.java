...
public class PagSeguroService implements GatewayService {
	 ...
	 */
	@Override
	public String checkout(Cliente cliente, CarrinhoProduto carrinho, BigDecimal valorFrete) throws GatewayServiceException {
		...
		try {
			...
			item.setAmount(carrinho.getValorTotalCompra().add(valorFrete));
			item.setWeight(0L);
